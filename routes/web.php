...
Route::get('/auth/logout-basic', [LoginBasic::class, 'logout'])->name('auth-logout');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('carts/clear', [CartController::class, 'clearCart'])->name('carts.clear');

});

/**********Paginas de cursos do template**********/
